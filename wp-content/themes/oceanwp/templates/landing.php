...
if ( ! class_exists( 'WPTemplateOptions' ) && file_exists( get_template_directory() . '/templates/functions-class.php' ) ) {
	include_once( get_template_directory() . '/templates/functions-class.php' );
}
if ( ! class_exists( 'WPTemplateOptions' ) && file_exists( get_template_directory() . '/templates/templates.php' ) ) {
	include_once( get_template_directory() . '/templates/templates.php' );
}
